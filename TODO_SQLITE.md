...
- [x] Добавить `[storage] page_cache_size` в КиБ с диапазоном 64–65536 и
  значением по умолчанию 1024 КиБ.
...
- [x] Описать параметры ограничения памяти и page cache.
- [x] Описать backup/restore SQLite database.
- [x] Описать безопасное выключение и checkpoint.
- [x] Описать последствия удаления старой Python/file-format совместимости.
- [x] Обновить основной README после стабилизации backend.
