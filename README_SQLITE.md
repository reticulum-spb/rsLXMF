...
- краткоживущее состояние peers и job loop.
...
Позднее в эту же базу могут быть добавлены таблицы:

- `known_identities`;
- `received_ratchets`;
- `tickets`;
- `stamp_costs`;
- `peers`, если профилирование покажет необходимость их сохранения в БД.
...
7. По результатам профилирования перенести identities, ratchets, tickets и
   stamp costs.
8. Удалить устаревшие файловые persistence-функции после завершения миграции.
